...
private static final String UPDATE_SINGLE_WORKPLACE_URL="http://minifacebook-service/about-update/workplace/update/";
//----------------------------------------------------------------------------------------------------------------
//UPDATE PROFESSIONAL SKILLS BY URL
private static final String UPDATE_SINGLE_PROFESSIONAL_SKILLS_URL="http://minifacebook-service/about-update/professionalSkills/update/";
//----------------------------------------------------------------------------------------------------------------
//UPDATE COLLEGE BY URL
private static final String UPDATE_SINGLE_COLLEGE_URL="http://minifacebook-service/about-update/college/update/";
//----------------------------------------------------------------------------------------------------------------
//UPDATE HIGH SCHOOL BY URL
private static final String UPDATE_SINGLE_HIGHSCHOOL_URL="http://minifacebook-service/about-update/highSchool/update/";
//----------------------------------------------------------------------------------------------------------------
//UPDATE CURRENT CITY BY URL
private static final String UPDATE_SINGLE_CURRENT_CITY_URL="http://minifacebook-service/about-update/currentCity/update/";
//----------------------------------------------------------------------------------------------------------------
//UPDATE HOME TOWN BY URL
private static final String UPDATE_SINGLE_HOMETOWN_URL="http://minifacebook-service/about-update/homeTown/update/";
//----------------------------------------------------------------------------------------------------------------
//OTHERPLACES LIVED BY URL
private static final String UPDATE_SINGLE_OTHERPLACESLIVED_URL="http://minifacebook-service/about-update/otherPlacesLived/update/";
//----------------------------------------------------------------------------------------------------------------
//CONTACT INFORMATION BY URL
private static final String UPDATE_SINGLE_CONTACT_INFORMATION_URL="http://minifacebook-service/about-update/contactInformation/update/";
//----------------------------------------------------------------------------------------------------------------
//WEBSITE AND SOCIAL LINK BY URL
private static final String UPDATE_SINGLE_WEBSITE_AND_SOCIAL_LINK_URL="http://minifacebook-service/about-update/webSiteAndSocialLink/update/";
//----------------------------------------------------------------------------------------------------------------
//BASIC INFORMATION BY URL
private static final String UPDATE_SINGLE_BASIC_INFORMATION_URL="http://minifacebook-service/about-update/basicInformation/update/";
//----------------------------------------------------------------------------------------------------------------
//RELATION SHIP BY URL
private static final String UPDATE_SINGLE_RELATIONSHIP_URL="http://minifacebook-service/about-update/relationShip/update/";
//----------------------------------------------------------------------------------------------------------------
//FAMILY MEMBERS BY URL
private static final String UPDATE_SINGLE_FAMILY_MEMBERS_URL="http://minifacebook-service/about-update/familyMembers/update/";
//----------------------------------------------------------------------------------------------------------------
//FAVORITE QUOTES BY URL
private static final String UPDATE_SINGLE_FAVORITE_QUOTES_URL="http://minifacebook-service/about-update/favoriteQuotes/update/";
