...
//----------------------------------------------------------------------------------------------------------------
private static final String ADD_SMALL_DATA="http://minifacebook-service/friends/smalldata/add";
private static final String GET_ALL_ADD_FRIENDS_DATA="http://minifacebook-service/friends/smalldata/getAll";
