...
//-------------------------------------------------------------------------------------------------------
private static final String ADD_LOGIN_INFORMATION="http://minifacebook-service/login/add/information";
//-------------------------------------------------------------------------------------------------------
private static final String GET_LOGIN_INFORMATION="http://minifacebook-service/login/get/information";
