...
private static final String DELETE_SINGLE_WORKPLACE_URL="http://minifacebook-service/about-delete/workplace/single/delete/";
//------------------------------------------------------------------------------------------------------
//DELETE PROFESSIONAL SKILLS BY URL
private static final String DELETE_SINGLE_PROFESSIONAL_SKILLS_URL="http://minifacebook-service/about-delete/professionalSkills/single/delete/";
//-------------------------------------------------------------------------------------------------------------
//DELETE COLLEGE BY URL
private static final String DELETE_SINGLE_COLLEGE_URL="http://minifacebook-service/about-delete/college/single/delete/";
//---------------------------------------------------------------------------------------------------------------
//DELETE HIGHSCHOOL BY URL
private static final String DELETE_SINGLE_HIGHSCHOOL_URL="http://minifacebook-service/about-delete/highSchool/single/delete/";
//---------------------------------------------------------------------------------------------------------------
//DELETE CURRENT CITY BY URL
private static final String DELETE_SINGLE_CURRENT_CITY_URL="http://minifacebook-service/about-delete/currentCity/single/delete/";
//---------------------------------------------------------------------------------------------------------------
//DELETE HOME TOWN BY URL
private static final String DELETE_SINGLE_HOMETOWN_URL="http://minifacebook-service/about-delete/homeTown/single/delete/";
//---------------------------------------------------------------------------------------------------------------
//DELETE OTHER PLACES LIVED BY URL
private static final String DELETE_SINGLE_OTHERPLACES_LIVED_URL="http://minifacebook-service/about-delete/otherPlacesLived/single/delete/";
//---------------------------------------------------------------------------------------------------------------
//DELETE CONTACT INFORMATION BY URL
private static final String DELETE_SINGLE_CONTACT_INFORMATION_URL="http://minifacebook-service/about-delete/contactInformation/single/delete/";
//---------------------------------------------------------------------------------------------------------------
//DELETE WEBSITE AND SOCIAL LINK BY URL
private static final String DELETE_SINGLE_WEBSITE_AND_SOCIAL_LINK_URL="http://minifacebook-service/about-delete/webSiteAndSocialLink/single/delete/";
//---------------------------------------------------------------------------------------------------------------
//DELETE BASIC INFORMATION BY URL
private static final String DELETE_SINGLE_BASIC_INFORMATION_URL="http://minifacebook-service/about-delete/basicInformation/single/delete/";
//---------------------------------------------------------------------------------------------------------------
//DELETE RELATION SHIP BY URL
private static final String DELETE_SINGLE_RELATIONSHIP_URL="http://minifacebook-service/about-delete/relationShip/single/delete/";
//---------------------------------------------------------------------------------------------------------------
//DELETE FAMILY MEMBERS BY URL
private static final String DELETE_SINGLE_FAMILY_MEMBERS_URL="http://minifacebook-service/about-delete/familyMembers/single/delete/";
//---------------------------------------------------------------------------------------------------------------
//DELETE FAVORITE QUOTES BY URL
private static final String DELETE_SINGLE_FAVORITE_QUOTES_URL="http://minifacebook-service/about-delete/favoriteQuotes/single/delete/";
