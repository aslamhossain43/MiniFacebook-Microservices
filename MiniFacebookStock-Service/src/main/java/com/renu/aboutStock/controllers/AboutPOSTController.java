...
// WORKPLACE ADD URL
private static final String WORKPLACE_ADD_URL="http://minifacebook-service/aboutService-post/workplace/add";
//------------------------------------------------------------------------------------------------------
//REPOSITORY
@Autowired
ProfessionalSkillRepository professionalSkillRepository;
//PROFESSIONAL SKILLS ADD URL
private static final String PROFESSIONAL_SKILLS_ADD_URL="http://minifacebook-service/aboutService-post/professionalSkills/add";
//------------------------------------------------------------------------------------------------------
//REPOSITORY
@Autowired
CollegeRepository collegeRepository;
//COLLEGE ADD URL
private static final String COLLEGE_ADD_URL="http://minifacebook-service/aboutService-post/college/add";
//------------------------------------------------------------------------------------------------------
//REPOSITORY
@Autowired
HighSchoolRepository highSchoolRepository;
//COLLEGE ADD URL
private static final String HIGHSCHOOL_ADD_URL="http://minifacebook-service/aboutService-post/highSchool/add";
//------------------------------------------------------------------------------------------------------
//REPOSITORY
@Autowired
CurrentCityRepository currentCityRepository;
//CURRENT CITY ADD URL
private static final String CURRENT_CITY_ADD_URL="http://minifacebook-service/aboutService-post/currentCity/add";
//------------------------------------------------------------------------------------------------------
//REPOSITORY
@Autowired
HomeTownRepository homeTownRepository;
//HOME TOWN ADD URL
private static final String HOMETOWN_ADD_URL="http://minifacebook-service/aboutService-post/homeTown/add";
//------------------------------------------------------------------------------------------------------
//REPOSITORY
@Autowired
OtherPlacesLivedRepository otherPlacesLivedRepository;
//HOME TOWN ADD URL
private static final String OTHERPLACESLIVED_ADD_URL="http://minifacebook-service/aboutService-post/otherPlacesLived/add";
//------------------------------------------------------------------------------------------------------
//REPOSITORY
@Autowired
ContactInformationRepository contactInformationRepository;
//CONTACT INFORMATION ADD URL
private static final String CONTACTINFORMATION_ADD_URL="http://minifacebook-service/aboutService-post/contactInformation/add";
//------------------------------------------------------------------------------------------------------
//REPOSITORY
@Autowired
WebSiteAndSocialLinkRepository webSiteAndSocialLinkRepository;
//WEBSITE AND SOCIAL LINK ADD URL
private static final String WEBSITE_AND_SOCIAL_LINK_ADD_URL="http://minifacebook-service/aboutService-post/webSiteAndSocialLink/add";
//------------------------------------------------------------------------------------------------------
//REPOSITORY
@Autowired
BasicInformationRepository basicInformationRepository;
//BASIC INFORMATION ADD URL
private static final String BASIC_INFORMATION_ADD_URL="http://minifacebook-service/aboutService-post/basicInformation/add";
//------------------------------------------------------------------------------------------------------
//REPOSITORY
@Autowired
RelationShipRepository relationShipRepository;
//RELATION SHIP ADD URL
private static final String RELATIONSHIP_ADD_URL="http://minifacebook-service/aboutService-post/relationShip/add";
//------------------------------------------------------------------------------------------------------
//REPOSITORY
@Autowired
FamilyMembersRepository familyMembersRepository;
//FAMILY MEMBERS ADD URL
private static final String FAMILYMEMBERS_ADD_URL="http://minifacebook-service/aboutService-post/familyMembers/add";
//------------------------------------------------------------------------------------------------------
//REPOSITORY
@Autowired
FavoriteQuotesRepository favoriteQuotesRepository;
//FAVORITE QUOTES ADD URL
private static final String FAVORITE_QUOTES_ADD_URL="http://minifacebook-service/aboutService-post/favoriteQuotes/add";
//-------------------------------------------------------------------------------------------------------------------
	// WORKPLACE ADD
